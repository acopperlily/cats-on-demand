...
const Modal = props => {
  ...
  return (
    ...
    <div className="modal">
      ...
      <div className="exitContainer clickable" onClick={props.handleClick}>
        <FaTimesCircle className='exit' />
      </div>

      <h3>Welcome to Cat On Demand!</h3>

      <div className="pContainer">

        <p>COD is a web application that retrieves cat photos and GIFs from <a href="https://cataas.com/#/" target='_blank' rel='noopener' className='clickable' >Cataas</a> (Cat as a Service) API.*</p>
        ...
        <p><small>* <a href="https://cataas.com/#/" target='_blank' rel='noopener' className='clickable'>Cataas</a> is currently in "under recovery mode", and there may be interruptions in service as they migrate to a new server. If you encounter any errors, admire my darling Pele and try demanding a cat some other time.***</small></p>
